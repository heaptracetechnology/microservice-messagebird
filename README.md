# _MessageBird_ Open Microservice

> This is an messagebird service
...
| :------------ | :------- | :------- | :------ | :--------------------------- |
| from          | `string` | `true`   | None    | The sender number.           |
| to            | `string` | `false`  | None    | The receiver number.         |
| message       | `string` | `true`   | None    | The message text body.       |
| API_KEY       | `string` | `true`   | None    | Access token for MessageBird |
...
[![Edit messagebird on CodeSandbox](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/oms-services/messagebird)
